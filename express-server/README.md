...
## Run in Docker
### Build the image
Run `docker build -t 'my-sodastream-api' .`
### Spin up a container
Run the api with the docker profile active: `docker run --name my-sodastream-api_1 -p 9000:9000 my-sodastream-api npm run docker`
