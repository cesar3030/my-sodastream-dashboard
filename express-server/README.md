...
## Run in Docker
### Build the image
Run `docker build -t 'my-sodastream-dashboard-api' .`

### Spin up a container
Run the api with the docker profile active: `docker run --name my-sodastream-api_1 -p 9000:9000 my-sodastream-dashboard-api`


## Debug
### Setup Debug mode in VSC
https://medium.com/@drcallaway/debugging-es6-in-visual-studio-code-4444db797954  

Then run `npm run compile` and start a debug session in VSC.
