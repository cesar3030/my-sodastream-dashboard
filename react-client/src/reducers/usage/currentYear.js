...
const currentYear = (
  ...
  switch (action.type) {
    case FETCH_CURRENT_YEAR_USAGE_PER_DATE_FAILURE:
      return {
        ...state,
        perDate: {
          ...state.perDate,
    ...
    case FETCH_CURRENT_YEAR_USAGE_PER_DATE_BEGIN:
      return {
        ...state,
        perDate: {
          ...state.perDate,
    ...
    case FETCH_CURRENT_YEAR_USAGE_PER_DATE_SUCCESS:
      return {
        ...state,
        perDate: {
          ...state.perDate,
    ...
    case FETCH_CURRENT_YEAR_USAGE_VOLUME_FAILURE:
      return {
        ...state,
        volume: {
          ...state.count,
    ...
    case FETCH_CURRENT_YEAR_USAGE_VOLUME_BEGIN:
      return {
        ...state,
        volume: {
          ...state.count,
    ...
    case FETCH_CURRENT_YEAR_USAGE_VOLUME_SUCCESS:
      return {
        ...state,
        volume: {
          ...state.count,
